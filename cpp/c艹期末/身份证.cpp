...
//	cout<<"(!birthday.check())"<<endl;
	...
	//
//	cout<<"p_id15[i]<'0'||p_id15[i]>'9"<<endl;
	
	if(birthday.getDay()%10!=(p_id15[11]-'0')||birthday.getDay()/10!=(p_id15[10]-'0')
	||birthday.getMonth()%10!=(p_id15[9]-'0')||birthday.getMonth()/10!=(p_id15[8]-'0')
	||birthday.getYear()%10!=(p_id15[7]-'0')||birthday.getYear()/10%10!=(p_id15[6]-'0'))
	return false;
	//
//	cout<<"(irthday.getDay()%10!=p_)"<<endl;
 	return true;
 } 
class CNewID:virtual public COldID
{
 ...
 bool CNewID::check()
 {
 	...
 	return false;
 	//
// 	cout<<"COldID::check()"<<endl; 
 	
	 if(strlen(p_id18)!=18) 
 	return false;
 	//
//// 	cout<<"strlen(p_id18)!=18"<<endl; 
 	if(!issueday.check())
 	return false;
 	//
// 	cout<<"!issueday.check()"<<endl; 
	...
	return false;
	//
//	cout<<"sueday.getYear()+validyear)<2015|"<<endl; 
	...
	if(strcmp(newid18,p_id18)!=0) return false;
	return true;
};
